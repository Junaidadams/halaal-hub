...
const Home = () => {
  return (
    <Wrapper>
      <div className="relative m-auto w-full font-poppins flex overflow-hidden h-screen">
        {/* Video Background */}
        <video
        ...
        />
        {/* Content */}
        <div className="relative z-10 w-fit m-auto flex flex-col bg-richBlack bg-opacity-80 dark:bg-ghost dark:bg-opacity-80 p-4 shadow-sm">
