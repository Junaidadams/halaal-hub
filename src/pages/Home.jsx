...
const Home = () => {
  return (
    <Wrapper>
      <div className="relative m-auto w-full font-poppins flex items-center justify-center overflow-hidden h-[calc(100vh-56px)]">
        {/* Video Background */}
        {/* <video
          className="absolute top-0 left-0 w-full h-full object-cover z-0 brightness-95 dark:brightness-75"
          src="/herovid.mp4"
          autoPlay
          loop
          muted
