  ...
  return (
    <Wrapper>
      <div className="mx-auto my-20 min-h-screen w-[95%] flex flex-col">
        ...
        <div className="flex mx-auto  sm:w-2/3 xl:w-1/2 border-b border-black dark:border-slate-300 border-dashed pb-20">
          <AboutText
        ...
        <div className="flex mx-auto py-20 sm:w-2/3 xl:w-1/2 border-b border-black dark:border-slate-300 border-dashed">
          <AboutText
